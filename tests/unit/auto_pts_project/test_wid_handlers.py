"""auto_pts_project.pybluehost.wid.* — WID adapter shape + upstream-graceful fallback."""
import pytest


def test_wid_modules_load():
    """All four WID modules import cleanly even without autoptsclient on sys.path."""
    from auto_pts_project.pybluehost.wid import gap, gatt, l2cap, sm
...
def test_wid_dicts_inherit_upstream_when_available():
    ...
    from auto_pts_project.pybluehost.wid import gap as pb_gap
