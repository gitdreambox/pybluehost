...
**当前进行中**：Pytest Transport Selection — Codex session，Task 17 已完成；Task 19 已提前完成（test_usb_smoke 迁移）
**下一步**：打开 [pytest-transport-selection](plans/pytest-transport-selection.md)，从 Task 18 第一个 `- [ ]` 继续
