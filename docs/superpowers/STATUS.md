...
**当前进行中**：Pytest Transport Selection — Codex session，Task 18 已完成；Task 19 已提前完成（test_usb_smoke 迁移）
**下一步**：打开 [pytest-transport-selection](plans/pytest-transport-selection.md)，从 Task 20 第一个 `- [ ]` 继续
...
- **认领人**：Codex session
- **开始时间**：2026-04-27
- **当前进度**：Task 18 完成；Task 19 已提前完成；下一步 Task 20（共 23 Task；Task 2 full-suite verification deferred by pre-existing hardware tests）
- **最后更新**：2026-04-28
