...
**当前进行中**：Pytest Transport Selection — Codex session，Task 13 已完成（删除 integration conftest 死代码）
**下一步**：打开 [pytest-transport-selection](plans/pytest-transport-selection.md)，从 Task 14 第一个 `- [ ]` 继续
