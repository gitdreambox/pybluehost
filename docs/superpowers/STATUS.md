...
| v1.2 Phase 2 P.8 | L2CAP BTP service skeleton（T1）+ T2-T5 阻塞等待 LE CoC manager 扩展，扩展已完成 → P.8 T2-T5 现可推进 | 🚧 T1 ✅；T2-T5 待恢复 | [p.8](plans/2026-06-08-v1.2-phase2-p8-l2cap-smp-btp.md) | `pybluehost/pts/btp/services/l2cap.py`, `pybluehost/pts/btp/opcodes.py` |
...
**总计：43 个 Plan（原 41 个 + LE CoC manager 扩展 + v1.2 Phase 2 P.8 skeleton；P.8 T2-T5 待续）**
