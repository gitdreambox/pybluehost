"""SnifferSpec — parsed virtual-sniffer specification (backend + options).

This module belongs to the sniffer layer.  The CLI layer imports from here;
the sniffer layer must NOT import from pybluehost.cli.
"""
